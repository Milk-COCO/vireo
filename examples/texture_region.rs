...
fn main() {
    ...
    app.run(move |app| {
        ...
        // 画整张纹理
        draw_texture(&mut batch, &tex,
            TextureOptions::default().rect(20.0, 80.0, tex.width as f32 * s, tex.height as f32 * s));
        ...
        draw_texture(&mut batch, &tex,
            TextureOptions::default().rect(180.0, 80.0, w2 as f32 * s, h2 as f32 * s).uv(u0, v0, u1, v1));

        // 右下角 1/2 区域
        let (u0, v0, u1, v1) = tex.uv(w2, h2, w2, h2);
        draw_texture(&mut batch, &tex,
            TextureOptions::default().rect(280.0, 80.0, w2 as f32 * s, h2 as f32 * s).uv(u0, v0, u1, v1));
