...
fn main() {
    ...
    app.run(move |app| {
        ...
        draw_rectangle(&mut b1, 20.0, 60.0, 140.0, 50.0, Color::new(0.8, 0.15, 0.15, 0.9));
        ...
        draw_rectangle(&mut b2, 130.0, 60.0, 170.0, 50.0, Color::new(0.15, 0.7, 0.15, 0.95));
        ...
        draw_rectangle(&mut b3, 270.0, 60.0, 180.0, 50.0, Color::new(0.15, 0.25, 0.8, 0.95));
