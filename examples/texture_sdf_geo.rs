...
fn draw_shapes(batch: &mut DrawBatch) {
    ...
    draw_polygon(
        batch,
        &[(680.0, 10.0), (730.0, 10.0), (730.0, 75.0), (680.0, 75.0)],
        Some(WHITE),
    );
    ...
    draw_line_chain(
        batch,
        &[(10.0, 120.0), (80.0, 100.0), (150.0, 110.0)],
        5.0,
        Some(WHITE),
    );
    ...
    app.run(move |ctx| {
        ...
        match tex {
            Some(i) => {
                ...
                draw_text(
                    &mut geo.texts,
                    "Geometry (sdf_feather = None)",
                    Pos::new(10.0, 155.0),
                    TextDef::default().font_size(14.0),
                    TextOverride::from_color(label),
                );
            ...
            None => {
                ...
                draw_text(
                    &mut batch.texts,
                    "Place logo_quad.png in the project root.",
                    Pos::new(150.0, 160.0),
                    TextDef::default().font_size(18.0),
                    TextOverride::from_color(Color::new(0.8, 0.8, 0.8, 1.0)),
                );
