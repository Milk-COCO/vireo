...
fn main() {
    ...
    app.run(move |app| {
        ...
        // ====== 填充形状 ======
        draw_rectangle(&mut batch, 20.0, 20.0, 100.0, 80.0, Some(RED));
        draw_circle(&mut batch, 200.0, 60.0, 40.0, Some(GREEN));
        draw_ellipse(&mut batch, 340.0, 60.0, 60.0, 40.0, Some(Color::new(0.2, 0.6, 1.0, 1.0)));
        draw_rounded_rect(&mut batch, 460.0, 20.0, 100.0, 80.0, 20.0, Some(ORANGE));
        ...
        draw_arc(&mut batch, 930.0, 60.0, 50.0, 0.0, PI * 0.75, Some(PINK));
        ...
        // ====== 描边形状 ======
        let y = 170.0;
        draw_rect_outline(&mut batch, 20.0, y, 100.0, 80.0, 4.0, Some(RED));
        draw_circle_outline(&mut batch, 200.0, y + 40.0, 40.0, 4.0, Some(GREEN), 48);
        draw_ellipse_outline(&mut batch, 340.0, y + 40.0, 60.0, 40.0, 4.0, Some(Color::new(0.2, 0.6, 1.0, 1.0)), 48);
        draw_rounded_rect_outline(&mut batch, 460.0, y, 100.0, 80.0, 20.0, 4.0, Some(ORANGE), 16);
        ...
        draw_arc_outline(&mut batch, 930.0, y + 40.0, 50.0, 0.0, PI * 0.75, 4.0, Some(PINK), 24);
