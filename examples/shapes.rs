...
async fn main() {
    ...
    app.run(move |ctx| {
        ...
        let fill_labels = [
            "Rect", "Circle", "Ellipse", "RndRect", "Triangle", "Polygon", "Arc",
        ];
