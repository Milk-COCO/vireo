...
async fn main() {
    ...
    app.run(move |ctx| {
        ...
        draw_text(
            &mut title.texts,
            "batch.text() vs draw_text(): transform follows shapes",
            Pos::new(10.0, 10.0),
            TextDef::default().font_size(13.0),
            TextOverride::from_color(Color::new(0.6, 0.6, 0.8, 1.0)),
        );
        ...
        b1.text(
            ...
            Pos::new(22.0, 50.0),
            TextDef::default().font_size(13.0),
            TextOverride::from_color(yl),
        );
        b1.text(
            "geometry + text move together",
            Pos::new(22.0, 67.0),
        ...
        draw_rectangle(
            ...
            100.0,
            20.0,
            Some(Color::new(0.15, 0.5, 0.3, 0.2)),
        );
        b2.text(
            "rotate 20°",
            Pos::new(5.0, 2.0),
